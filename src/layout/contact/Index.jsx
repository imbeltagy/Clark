...
import MotionDiv, { MotionChild } from "/src/common/motionDiv/Index";
      ...
      <div className="container">
        ...
        <div className="mt-3 row row-cols-md-2 row-cols-lg-4 gy-5 gx-5 gx-lg-3">
          {contactInfo.map(({ icon, title, details }) => (
            <MotionDiv className="wrapper text-center" key={title}>
        ...
        {/* Contact Form */}
        <MotionDiv className="row g-0 row-cols-md-2 flex-md-row-reverse mt-5 pt-5">
